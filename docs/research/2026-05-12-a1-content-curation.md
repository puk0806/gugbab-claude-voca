...
- **(2026-05-13 적용 갱신)** 실제 프로젝트 적용 단계에서 *본인 1인용 학습 PWA* 특성을 반영해 **649 단어 / 250 문장으로 상향 적용** (4단계 점진 확장: 80→300→600→648→649 단어, 40→150→250 문장). 결정 근거·카테고리별 실제 분포·다의어 8개·formulaic pattern 그룹은 §4.6 참고.
...
### 4.6 적용 결정 (2026-05-13 갱신) — 649 단어 / 250 문장

리서치 권장(220 단어 / 100 문장)을 *4단계 점진 확장으로 649 단어 / 250 문장*으로 최종 적용. 본 섹션은 결정 근거·카테고리별 실제 적용 분포·다의어 8개·일상 회화 시나리오 매핑·formulaic pattern 보강을 정리한다.
...
- **문장 250 적용**: 1차 150 문장은 Cambridge Empower / New Headway A1 8~15 문장 × 10 unit = *80~150 상한* 구성(상황 시나리오 12개 분포). 2차 +100 문장은 *고빈도 formulaic pattern*(NGSL-Spoken multi-word expression · Empower functional language · Spoken BNC2014 4-gram pattern 등) 보강. 어휘 649 대비 문장 250은 *시나리오 시뮬레이션(150) + 발화 정형 표현(100)*의 두 축 학습 모듈로 구성.
...
#### 4.6.5d 회화 빈도 상위 formulaic pattern 보강 (2026-05-13)

A1 학습자가 영어권 일상에서 *즉시 사용해야 하지만 단어 단위 vocabulary로는 익히기 어려운 정형 표현(formulaic sequences)*을 보강. 단순 단어 학습이 *어휘 폭은 넓혀도 발화 유창성은 보장하지 않는다*는 corpus linguistics 연구 결과(Wray 2002, Schmitt 2010)에 따라, A1 단어 풀 위에 *고빈도 chunk·collocation·discourse marker*를 별도 학습 단위로 도입한다.

**참조 자료**:
- **NGSL-Spoken (NGSL-S) v1.2** — multi-word expression 추출 (gonna · gotta · wanna · kinda 등 reduced form 상위)
- **Cambridge Empower A1~A2 "Everyday English"** — functional language 카테고리(suggestion · clarification · politeness 등) 분류 골격
- **British Council A1 Speaking** — daily exchange functional phrases
- **Lancaster CASS Spoken BNC2014** — 상위 200개 4-gram·5-gram pattern (informal conversation 코퍼스 기반)
- **COCA Spoken sub-corpus** — 미국 회화 빈도 collocate 매트릭스

위 자료 교차 분석으로 *회화 빈도 상위 약 100개 formulaic pattern*을 추출, 자체 응용 예문으로 변환하여 s_a1_151~s_a1_250에 추가.

**언어학적 분류 — 15개 기능군**:

| 기능군 | 언어학적 카테고리 | 대표 패턴 | 문장 ID |
|---|---|---|---|
| 의도·계획 표현 | reduced future / modal aux | I'm gonna · I gotta · I get to | 151, 158, 159 |
| 인지·추측 양태 | epistemic modality + hedging | I'm guessing · I just think · I had no idea | 152, 162, 167 |
| 부정·완곡 | negative hedge | I'm not saying · I didn't mean to · I wouldn't | 153, 165, 172 |
| 정서·선호 | be + intensifier + preposition | I'm all about · I'm dying to · I'm sick of · I'm not big on | 154~157 |
| 1인칭 modal hedge | modal aux + adverb | I can't really · I'd better · I might just | 168, 170, 171 |
| 완결 과거·후회 (perfect modal) | modal + perfect have | I must've · I was hoping · I knew | 160, 166, 173 |
| 2인칭 확인 (interrogative tag) | rising-intonation question | You're saying...? · You're telling me...? · You sure...? · You do realize...? | 174, 175, 179, 184 |
| 2인칭 제안·권유 | suggestion modal | You could · You might wanna · You gotta · You wanna | 176~178, 180 |
| 3인칭 it 일반화 (impersonal it) | dummy subject + adjective | It's a little · It's just that · It's not like · It's practically · It's supposed to | 185~189 |
| 지시 + 평가 (deictic evaluator) | demonstrative + intensifier | This is why · That's pretty · That must've been · No one's that | 190~193 |
| 통찰 의미화 (presentative) | indefinite + cognitive | Something tells me · No wonder · Turns out | 194, 215, 232 |
| WH 정형 의문 | formulaic question | What happens if · What makes you think · Whatever happened to · What's with · Who says · Who would've thought | 195~202 |
| 비공식 의문 (informal interrogative) | reduced WH | How's...? · How was...? · How come...? · Why don't we...? · Why not just...? | 203~207 |
| 청유·집단 화행 (cohortative) | let-imperative | Let's just · Let's not · We should probably | 208, 209, 216 |
| 술부 후미사·삽입 (sentence-final / parenthetical) | reduced clause | ..., that's all · ..., by any chance · ..., or something · ...is your best bet · How does ... sound? | 240~243, 248 |

100개라는 분량은 *Cambridge English Empower A1 syllabus의 functional language 셀(약 80~100 expressions) + Lancaster Spoken BNC2014 상위 100 formulaic sequence*의 교집합 + 한국 EFL 학습자가 영어권 일상 회화에서 *놓치기 쉬운 reduced form / discourse marker* 보강의 균형점으로 산정했다.

한국어 번역은 *학습자가 일상에서 즉시 떠올릴 회화체*로 자체 작성·재구성. 영문 예문도 *원 패턴의 응용*이며 인용 X.

**단어 1개 추가**: admit (w_a1_674) — "You gotta admit it" 패턴의 핵심 동사. Oxford 3000 A2 분류이지만 회화 빈도 상위라 A1 등재(EVP의 *get to admit* collocation 빈도 근거).

#### 4.6.6 cloze 일관성 최종 검증

작성된 250개 문장의 `{cloze}` 마커 ↔ `cloze` 배열 매칭률 **100%** (250/250). cloze 단어 ↔ 단어장 정합성 (활용형·기능어·불규칙 OK 처리 후) **100%** (250/250 통과). 즉 학습자가 *단어장 → 문장* 순서로 학습 가능, 누락된 어휘 없음.
...
*적용 갱신: 2026-05-13 — §4.6 추가, 권장 220/100 → 최종 적용 649/250 (4단계 점진 확장: 80→300→600→648→649 단어, 40→150→250 문장), 다의어 8개 확정, 일상 회화 시나리오 12개 매핑, deep-researcher 교차 검증 후 25↔25 교체 (§4.6.5b), 학습 흐름 정합성 완성 — 48개 추가 등재 + 문장 6개 수정으로 cloze 정합성 100% 달성 (§4.6.5c), 고빈도 formulaic pattern 보강 — admit 등재 + 100문장 추가 with 15개 기능군 분류 (§4.6.5d)*
